...
int number = numberSintesator.Next(10,100);
// Выводим на консоль число
Console.WriteLine(number);
// Получаем первую и вторую цифру
...
//Вариант2
//char[]digits = numberSintesator.Next(10,100).ToString().ToCharArray();
//Console.WriteLine(digits);
//int firstNumber = ((int)digits[0])-48;
//int secondNumber = ((int)digits[1])-48;
//Тернарный оператор
//resultNumber=firstNumber>secondNumber?resultNumber:resultNumber=secondNumber;
//Вывод на консоль
